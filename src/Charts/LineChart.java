...
public class LineChart extends javax.swing.JPanel {
	...
	public void setName(String name) {
		show = name == "y" ? true: false;
	}
    public LineChart(Color background, Color foreground,  float s) {
    	this.lineSize = s;
        ...
        blankPlotChart.setBlankPlotChatRender(new BlankPlotChatRender() {
            ...
            public void renderSeries(BlankPlotChart chart, Graphics2D g2, SeriesSize size, int index, List<Path2D.Double> gra) {
                ...
                for (int i = 0; i < legends.size(); i++) {
                    ...
                    if (index == 0) {
                    	...
                    	if(!(model.get(index).getValues()[i] == -0.1)) {   
            ...
            public void renderGraphics(Graphics2D g2, List<Path2D.Double> gra) {
				...
				g2.setStroke(new BasicStroke(lineSize, BasicStroke.CAP_ROUND, BasicStroke.JOIN_BEVEL));
    ...
    private void initComponents() {
        ...
        blankPlotChart.setForeground(backgroundColor);
        blankPlotChart.setForeground(foregroundColor);
